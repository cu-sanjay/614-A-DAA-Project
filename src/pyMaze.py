[9:38 am, 02/11/2023] +91 74130 90189: from pyMaze import maze,agent,COLOR
def DFS(m):
    start=(m.rows, m.cols)
    explored=[start]
    frontier=[start]
...
if _name=='main_':
    ...
    m.run()
[9:38 am, 02/11/2023] +91 74130 90189: import random, datetime, csv, os
from tkinter import *
...
class agent:
    ...
    def _init_(self, parentMaze, x=None, y=None, shape='square', goal=None, filled=False, footprints=False,
